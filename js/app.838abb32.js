		...
		var i = {
			...
			answers: {
				...
				array: [{
					...
					title: "2.元宇宙重要嗎？",
					text: "基於 Web3.0、全息互聯網技術、區塊鍊和NFT的融合，元宇宙概念所展現岀來的價值觀與互聯網核心價值相契合。 PI Network認為，元宇宙或許是互聯網的終極形態。因此，我們以遊戲為切入點，打造了SpacePi——基於NFT+元宇宙的虛擬人生區塊鏈遊戲，讓現實與虛擬的鏈接更加高效，也讓價值的流通更加豐富。在最近的全球疫情中，這些數字平台的重要性變得顯而易見。"
				}, {
	...
	"56d7": function(t, e, a) {
		...
		var L = a("8c4f"),
			K = function() {
				...
				return i("div", [i("div", {
					...
					staticClass: "partners-content wow PI Network-animation fade-out-min-in-max-animation"
					...
					staticClass: "what-container wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					...
					staticClass: "what-right wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "right-s"
				}, [i("div", {
					staticClass: "what-title"
					...
					staticClass: "what-left wow PI Network-animation fade-left-in-right-animation"
				}, [i("div", {
					staticClass: "left-s"
				}, [i("div", {
					staticClass: "what-title"
					...
					staticClass: "concept-title-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("span", {
					...
					staticClass: "concept-content wow PI Network-animation fade-right-in-left-animation"
				}, [i("span", [t._v(t._s(t.$t("station").text[0]))]), i(
					"span", [t._v(t._s(t.$t("station").text[1]))])])]), i("div", {
					staticClass: "concept-car wow PI Network-animation fade-in-up-animation"
				}, [i("div", {
				...
				"div", {
					...
					staticClass: "spacepiwep-img wow PI Network-animation fade-in-down-animation"
				}, [i("div", {
					...
					staticClass: "spacepiwep-title-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "line"
				}), i("span", {
					...
					.title))])]), i("div", {
					staticClass: "spacepiwep-content wow PI Network-animation fade-in-up-animation"
				}, [t._v(" " + t._s(t.$t("spacepiwep")
					.text) + " ")])]), i("a", {
					staticClass: "cta PI Networkwep-bnt wow PI Network-animation fade-in-up-animation",
					attrs: {
					...
					staticClass: "spacepiwep-img wow PI Network-animation fade-in-up-animation"
				}, [i("div", {
					staticClass: "spacepiwep-img-subject"
				}, [i("v-img", {
					attrs: {
					...
					staticClass: "spacepiwep-bnt wow PI Network-animation fade-in-up-animation"
				}, [t._v(" " + t._s(t.$t(
					...
					staticClass: "roadmap-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					...
					staticClass: "one-content wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					...
					staticClass: "one-content wow PI Network-animation fade-left-in-right-animation"
				}, [i("div", {
						staticClass: "one-title"
					...
					staticClass: "tokenomics-left-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					...
					.content) + " ")])])]), i("div", {
					staticClass: "tokenomics-content wow PI Network-animation fade-in-up-animation"
				}, [i("div", {
					...
					staticClass: "tokenomics-title-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "line"
				}), i("span", {
					staticClass: "tokenomics-title"
				}, [t._v(t._s(t.$t("Tokenomics").title))])]), i("div", {
					staticClass: "tokenomics--Vice-title wow PI Network-animation fade-right-in-left-animation"
				}, [t._v(t._s(t.$t("Tokenomics").text))]), i("div", {
					staticClass: "tokenomics-left-content wow PI Network-animation fade-out-min-in-max-animation"
					...
					staticClass: "choice-explain-content wow PI Network-animation fade-out-min-in-max-animation"
				}, [t._v(" " + t._s(t.$t("answers").text) +
					" ")])]), i("div", {
					staticClass: "choice-region wow PI Network-animation fade-in-up-animation"
				}, [i("div", {
			...
			z = function() {
				...
				return i("v-container", {
					...
					staticClass: "spacepi-title wow PI Network-animation fade-in-up-animation"
				}, [t._v("SPACE"), i("span", [t._v("PI")])]), i("span", {
					staticClass: "spacepi-vice-title fade-in-up-animation"
				}, [t._v(" " + t._s(t.$t("only")) + " ")]), i("span", {
					staticClass: "spacepi-content wow PI Network-animation fade-in-up-animation"
						...
						scopedSlots: t._u([{
							...
							fn: function(n) {
								...
								return [0 == a ? i("v-btn", t
										._g(t._b({
												staticClass: "left wow PI Network-animation fade-in-up-animation",
												on: {
													click: function(
														a
														) {
									...
									1 && 0 != a ? i("v-btn",
										t._g(t._b({
												staticClass: "wow PI Network-animation fade-in-up-animation",
												on: {
													click: function(
														a
														) {
									...
									1 ? i("v-btn", t._g(t
											._b({
													staticClass: "right wow PI Network-animation fade-in-up-animation",
													on: {
														click: function(
															a
															) {
					...
					staticClass: "spacepi-illustrate PI Network-animation fade-in-up-animation"
				}, [t._v(" " + t._s(t.$t("happy_text")) + " ")]), i("div", {
					staticClass: "spacepi-address PI Network-animation fade-in-up-animation"
				}, [i("div", {
					staticClass: "address"
				}, [i("svg", {
					...
					staticClass: "spacepi-address-m PI Network-animation fade-in-up-animation"
				}, [i("div", {
					staticClass: "address",
					staticStyle: {
						"text-align": "center"
		...
		var $ = function() {
			...
			mt = function() {
				...
				return i("v-container", {
					...
					staticClass: "telegram-title-subject concept-content wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "line"
				}), i("span", {
					staticClass: "telegraph-title"
				}, [t._v(t._s(t.$t("telegraph")))])]), i("div", {
					staticClass: "telegraph-grid concept-content wow PI Network-animation fade-in-up-animation"
		...
		var Pt = a("b918"),
			_t = function() {
				...
				return a("div", {
					...
					staticClass: "nft-top-bnt wow PI Network-animation fade-in-up-animation"
		...
		var jt = function() {
				...
				return i("div", [i("div", {
					...
					staticClass: "partners-title-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "line"
				}), i("span", {
					...
					"div", {
						staticClass: "partners-bnt-content wow PI Network-animation fade-in-up-animation"
					}, [i("div", {
					...
					return i("div", {
						...
						staticClass: "friendship-partner-title-subject wow PI Network-animation fade-right-in-left-animation"
					}, [i("div", {
						staticClass: "line"
					}), i("div", {
						...
						" ")])]), i("div", {
						staticClass: "friendship-partner-adsense wow PI Network-animation fade-in-up-animation"
		...
		var zt = function() {
				...
				return i("div", [i("div", {
					...
					staticClass: "wbnb-title-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					...
					staticClass: "lock-subject wow PI Network-animation fade-in-up-animation"
				}, [i("div", {
				...
				"span", {
					...
					staticClass: "spacepi-address-subject wow PI Network-animation fade-in-up-animation"
				}, [i("span", {
					...
					staticClass: "spacepi-bnt-container bnt-animation wow PI Network-animation fade-in-up-animation"
				}, [i("div", {
					...
					staticClass: "info-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("span", {
					staticClass: "info-text"
				}, [t._v("for PiNetwork & Elon Musk & PI Network Team")]), i(
					"div", {
					...
					return i("div", {
						key: n,
						staticClass: "contract-car wow PI Network-animation fade-in-up-animation"
					}, [i("div", {
		...
		var qt = function() {
				...
				return i("div", [i("div", {
					...
					staticClass: "task-subject wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "task-line"
				}), i("span", {
					staticClass: "task-title"
				}, [t._v("PI Network ARMY DAILY TASKS")])]), i("div", {
					staticClass: "task-vice wow PI Network-animation fade-right-in-left-animation"
				}, [t._v(
					" OK! Here are some PI Network Army missions! Let's take a few seconds to do the simple task! "
					)])]), i("div", {
					staticClass: "task-card-subject"
				}, [i("div", {
					staticClass: "task-card task-card-subject-b1 wow PI Network-animation fade-left-in-right-animation"
				}, [i("div", {
					...
					"div", [t._v(" → ")])])])])]), i("div", {
					staticClass: "task-card task-card-subject-b2 wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "task-card-title"
				}, [t._v(
					...
					"div", [t._v(" → ")])])])])]), i("div", {
					staticClass: "task-card task-card-subject-b3 wow PI Network-animation fade-left-in-right-animation"
				}, [i("div", {
					staticClass: "task-card-title"
				}, [t._v(
					...
					"div", [t._v(" → ")])])])])]), i("div", {
					staticClass: "task-card task-card-subject-b4 wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "task-card-title"
				}, [t._v(
					...
					"div", [t._v(" → ")])])])])]), i("div", {
					staticClass: "task-card task-card-subject-b5 wow PI Network-animation fade-left-in-right-animation"
				}, [i("div", {
					staticClass: "task-card-title"
				}, [t._v(
					...
					"div", [t._v(" → ")])])])])]), i("div", {
					staticClass: "task-card task-card-subject-b6 wow PI Network-animation fade-right-in-left-animation"
				}, [i("div", {
					staticClass: "task-card-title"
				}, [t._v(
		...
		var ie = function() {
				...
				return a("div", {
					...
					return a("div", {
						key: i,
						staticClass: "nft-subject wow PI Network-animation fade-in-up-animation"
					}, [a("div", {
	...
	"77bf": function(t, e, a) {
		...
		var i = {
			...
			spacepiwep: {
				...
				o: "صعد على متنها",
				bnt: "تقرير التدقيق",
				text: "بناءً على وجهة النظر هذه ، أصبحت PI Network أداة استثمار لشراء الأصول أو الخدمات الافتراضية في نظامها البيئي ، وسوف تنفجر بحيوية جديدة وقيمة غير مسبوقة مع تطبيق PI Network. فيما يلي بعض النقاط الرئيسية في نظام PI Network البيئي.",
				trend_bnt_title: "اتجاه PI Network",
				trend_bnt_url: "https://www.baidu.com/?tn=44004473_35_oem_dg"
			},
			...
			text: ["ستنشئ PI Network نظامًا بيئيًا رقميًا عالي المستوى غير مسبوق ، مما يوفر تجربة غمر رقمية بسيطة وفعالة كجوهر. يمنح قيمة تداول الرمز المميز ، ويسمح لمزيد من الأشخاص بالمشاركة في البناء البيئي لـ PI Network ، ويخلق عالمًا ترفيهيًا بلا حدود ، ويربط المستخدمين في كل ركن من أركان العالم ، ويؤسس بيئة metaverse غير مركزية وغير موثوقة للغاية للمستخدمين العالميين.",
				...
				"سيتم تقديم جميع مزايا PI Network في شكل الرمز المميز PI Network. إن الواقع الافتراضي والواقع لـ PI Network metaverse مترابطان للغاية ، وأصبح اقتصاد الحلقة المغلقة المرتبط بالمنصة مفتوحة المصدر الشكل النهائي للإنترنت."
			],
			tetxbu: "ورق ابيض",
			tetxbu_url: "https://drive.google.com/file/d/1SM-Cf646IGJ1_NDHJsMHABOi9f12xtvo/view?usp=sharing",
			contractAddress: "",
			down: ["شراء PI Network"],
			index_Liquidity_title: "السيولة مقفلة",
			index_Liquidity: "https://dxsale.app/app/v3_3/dxlockview?id=0&add=0x7f1b11a798273dA438b4b132dF1383d8387e73b4&type=lplock&chain=BSC",
			index_Goplus_title: "تدقيق Goplus",
			index_Goplus: "https://gopluslabs.io/token-security/56/0x0a6231128a5140dba469553ae34a92e830974b90",
			index_SpacePi_title: "سعر PI Network",
			index_SpacePi: [{
			...
			station: {
				enter: "نظام بيئي قوي PI Network",
				...
				text: ["أصبح الاقتصاد الرقمي نوعًا من الأصول المشروعة جديرًا بدراسة المستثمرين ، وقد انفجر بشكل كبير على المدى القصير.",
					"بناءً على وجهة النظر هذه ، أصبحت PI Network أداة استثمار لشراء الأصول أو الخدمات الافتراضية في نظامها البيئي ، وسوف تنفجر بحيوية جديدة وقيمة غير مسبوقة مع تطبيق PI Network. فيما يلي بعض النقاط الرئيسية في نظام PI Network البيئي."
				],
				c: [{
					title: "رمز PI Network",
			...
			answers: {
				...
				array: [{
					title: "1. ما هو metaverse الذي وصفه PI Network؟",
			...
			footer2: "حقوق النشر © 2021-2022 PI Network. كل الحقوق محفوظة",
			footer_twitter_url: "https://twitter.com/SpacePi_Com",
			footer_telegram_url: "https://t.me/PI_NetworkCN",
			footer_discord_url: "https://t.me/PI_NetworkCN",
			footer_reddit_url: "https://t.me/PI_NetworkCN",
	...
	"7b38": function(t, e, a) {
		...
		var i = {
			...
			spacepiwep: {
				...
				o: "Gemide",
				bnt: "TEFTİŞ RAPORU",
				text: "Bu bakış açısına dayanarak, ekosisteminde sanal varlık veya hizmet satın almak için bir yatırım aracı haline gelen PI Network, PI Network uygulamasıyla yeni bir canlılık ve eşi görülmemiş bir değerle patlayacak. İşte PI Network ekosisteminin bazı önemli noktaları.",
			...
			station: {
				...
				text: ["Dijital ekonomi, kısa vadede katlanarak artan, yatırımcıların dikkatine değer meşru bir varlık türü haline geldi.",
					"Bu bakış açısına dayanarak, ekosisteminde sanal varlık veya hizmet satın almak için bir yatırım aracı haline gelen PI Network, PI Network uygulamasıyla yeni bir canlılık ve eşi görülmemiş bir değerle patlayacak. İşte PI Network ekosisteminin bazı önemli noktaları."
				],
				c: [{
			...
			Tokenomics: {
				...
				content: "Demokratik taşıyıcımızı dünyanın dışında inşa etmek için PI Network, adil bir belirteç ekolojisine dayalı olarak piyasaya sürüldü.",
				array: [{
					title: "olmadan",
		...
		var i = {
			...
			answers: {
				...
				array: [{
					...
					text: "Based on the integration of Web3.0, holographic Internet technology, blockchain and NFT, the values presented by the concept of the Metaverse are in line with the core values of the Internet. PI Network believes that the metaverse may be the ultimate form of the Internet. Therefore, we took the game as the starting point and created PI Network, a virtual life blockchain game based on NFT+ metaverse, which makes the link between reality and virtuality more efficient and enriches the circulation of value. The importance of these digital platforms has become apparent during the recent global pandemic."
				}, {
			...
			partners_text: "Everything PI Network do now is to prove that the persistence of Pi Fans is worth it! Welcome more platforms and institutions to cooperate with PI Network, official contact email: pi@space-pi.com",
	...
	ca8a: function(t, e, a) {
		...
		var i = {
			...
			spacepiwep: {
				...
				text: "จากมุมมองนี้ PI Network ได้กลายเป็นเครื่องมือการลงทุนสำหรับการซื้อสินทรัพย์หรือบริการเสมือนในระบบนิเวศ และจะระเบิดพลังใหม่และคุณค่าที่ไม่เคยมีมาก่อนด้วยแอปพลิเคชัน PI Network นี่คือประเด็นสำคัญบางประการของระบบนิเวศ PI Network",
			...
			tetxbu_url: "https://drive.google.com/file/d/1SM-Cf646IGJ1_NDHJsMHABOi9f12xtvo/view?usp=sharing",
			contractAddress: "",
			down: ["ซื้อ PI Network"],
			index_Liquidity_title: "สภาพคล่องถูกล็อค",
			index_Liquidity: "https://dxsale.app/app/v3_3/dxlockview?id=0&add=0x7f1b11a798273dA438b4b132dF1383d8387e73b4&type=lplock&chain=BSC",
			index_Goplus_title: "Goplus Audit",
			index_Goplus: "https://gopluslabs.io/token-security/56/0x0a6231128a5140dba469553ae34a92e830974b90",
			index_SpacePi_title: "ราคา PI Network",
			index_SpacePi: [{
				title: "Dextools Trend"
			}, {
				title: "Poocoin Trend"
			...
			station: {
				...
				text: ["เศรษฐกิจดิจิทัลได้กลายเป็นสินทรัพย์ประเภทที่ถูกต้องตามกฎหมายที่นักลงทุนควรพิจารณา ซึ่งได้ขยายตัวอย่างรวดเร็วในระยะสั้น",
					"จากมุมมองนี้ PI Network ได้กลายเป็นเครื่องมือการลงทุนสำหรับการซื้อสินทรัพย์หรือบริการเสมือนในระบบนิเวศ และจะระเบิดพลังใหม่และคุณค่าที่ไม่เคยมีมาก่อนด้วยแอปพลิเคชัน PI Network นี่คือประเด็นสำคัญบางประการของระบบนิเวศ PI Network"
				],
				c: [{
					title: "PI Network Token",
					...
					title: "PI Network NFTs",
					text: "สินทรัพย์ดิจิทัลที่ไม่เป็นเนื้อเดียวกันและสามารถถ่ายโอนได้ซึ่งมีลักษณะเฉพาะสามารถกลายเป็นคอลเลคชันงานศิลปะหรืออุปกรณ์เกมในระบบนิเวศของ PI Network"
				}, {
					title: "PI Network DAO",
					...
					title: "PI Network Metaverse",
					text: "Gamified 3D Metaverse Virtual Space ในระบบนิเวศ PI Network"
				}, {
					title: "ตลาด NFT",
			...
			Community: {
				title: "เข้าร่วมชุมชนระดับโลกของ PI Network",
			...
			footer2: "ลิขสิทธิ์ © 2021-2022 PI Network. สงวนลิขสิทธิ์",
			footer_twitter_url: "https://twitter.com/SpacePi_Com",
			footer_telegram_url: "https://t.me/PI_NetworkCN",
			footer_discord_url: "https://t.me/PI_NetworkCN",
			footer_reddit_url: "https://t.me/PI_NetworkCN",
	...
	d935: function(t, e, a) {
		...
		var i = {
			...
			text: ["PI Networkは、前例のないトップレベルのデジタルエコシステムを作成し、コアとしてシンプルで効率的なメタバースデジタルイマージョンエクスペリエンスを提供します。 トークン循環の価値を与え、より多くの人々がSpacePiのエコロジー構築に参加できるようにし、ボーダレスエンターテインメントの世界を作り、世界の隅々にいるユーザーを結び付け、グローバルユーザーのための信頼できない高度に分散化されたメタバースエコロジーを確立します。",
				...
				"SpacePiのすべての利点は、ネイティブトークンSpacePiの形式で提示されます。 PI Networkメタバースの仮想と現実は高度に相互接続されており、オープンソースプラットフォームに接続された閉ループ経済はインターネットの最終形態になっています。"
			],
			tetxbu: "ホワイトペーパーを読む",
			tetxbu_url: "https://drive.google.com/file/d/1SM-Cf646IGJ1_NDHJsMHABOi9f12xtvo/view?usp=sharing",
			contractAddress: "",
			...
			partners_text: "PI Networkが今していることはすべて、Piファンの永続性がそれだけの価値があることを証明することです！ PI Networkと協力するためのより多くのプラットフォームと機関を歓迎します。公式の連絡先メールアドレス：pi@space-pi.com",
	...
	f1a7: function(t, e, a) {
		...
		var i = {
			...
			spacepiwep: {
				...
				o: "Di atas kapal",
				bnt: "LAPORAN AUDIT",
				text: "Berdasarkan sudut pandang ini, PI Network telah menjadi alat investasi untuk membeli aset atau layanan virtual di ekosistemnya, dan akan meledak dengan vitalitas baru dan nilai yang belum pernah ada sebelumnya dengan penerapan PI Network. Berikut adalah beberapa poin penting dari ekosistem PI Network.",
				trend_bnt_title: "Tren PI Network",
				trend_bnt_url: "https://www.baidu.com/?tn=44004473_35_oem_dg"
			},
			...
			text: ["PI Network akan menciptakan ekosistem digital tingkat atas yang belum pernah ada sebelumnya, memberikan pengalaman perendaman digital metaverse yang sederhana dan efisien sebagai intinya. Memberikan nilai sirkulasi token, memungkinkan lebih banyak orang untuk berpartisipasi dalam konstruksi ekologis PI Network, menciptakan dunia hiburan tanpa batas, menghubungkan pengguna di setiap sudut dunia, dan membangun ekologi metaverse yang tidak dapat dipercaya dan sangat terdesentralisasi untuk pengguna global.",
				...
				"Semua manfaat PI Network akan disajikan dalam bentuk token asli PI Network. Virtual dan realitas metaverse PI Network sangat saling berhubungan, dan ekonomi loop tertutup yang melekat pada platform sumber terbuka telah menjadi bentuk akhir dari Internet."
			],
			tetxbu: "Kertas putih",
			tetxbu_url: "https://drive.google.com/file/d/1SM-Cf646IGJ1_NDHJsMHABOi9f12xtvo/view?usp=sharing",
			contractAddress: "",
			down: ["Beli PI Network"],
			index_Liquidity_title: "Likuiditas Terkunci",
			index_Liquidity: "https://dxsale.app/app/v3_3/dxlockview?id=0&add=0x7f1b11a798273dA438b4b132dF1383d8387e73b4&type=lplock&chain=BSC",
			index_Goplus_title: "Audit Goplus",
			index_Goplus: "https://gopluslabs.io/token-security/56/0x0a6231128a5140dba469553ae34a92e830974b90",
			index_SpacePi_title: "Harga PI Network",
			index_SpacePi: [{
				title: "Tren Dextools"
			}, {
				title: "Tren Poocoin"
			...
			car: [{
				...
				title: "Dunia PI Network",
				content: "Memberikan nilai sirkulasi token, memungkinkan lebih banyak orang untuk berpartisipasi dalam konstruksi ekologis PI Network, menciptakan dunia hiburan tanpa batas, menghubungkan pengguna di setiap sudut dunia, dan membangun ekologi metaverse yang tidak dapat dipercaya dan sangat terdesentralisasi untuk pengguna global."
			}],
			station: {
				...
				text: ["Ekonomi digital telah menjadi jenis aset sah yang layak dipertimbangkan investor, yang telah meledak secara eksponensial dalam jangka pendek.",
					"Berdasarkan sudut pandang ini, PI Network telah menjadi alat investasi untuk membeli aset atau layanan virtual di ekosistemnya, dan akan meledak dengan vitalitas baru dan nilai yang belum pernah ada sebelumnya dengan penerapan PI Network. Berikut adalah beberapa poin penting dari ekosistem PI Network."
				],
				c: [{
					title: "Token PI Network",
					text: "Jenis token utilitas baru yang didukung oleh beberapa rantai publik, berfungsi sebagai fondasi dalam ekosistem PI Network, melayani berbagai aplikasi, dengan skenario aplikasi yang kuat"
				}, {
					title: "Pengantar PI Network",
					...
					text: "Aset digital yang tidak homogen dan dapat dialihkan dengan karakteristik unik dapat menjadi koleksi seni atau penyangga permainan di ekosistem PI Network."
				}, {
					title: "PI Network DAO",
					...
					title: "PI Network Metaverse",
					text: "Ruang Virtual Metaverse 3D Gamified di Ekosistem PI Network"
				}, {
					title: "pasar NFT",
					text: "PI Network Marketplace memungkinkan peserta untuk mengelola dan memperdagangkan NFT PI Network, yang diberi harga dalam PI Network sebagai mata uang sirkulasi"
				}]
			},
			car1: [{
				text: "Pi Network",
			...
			Community: {
				title: "Bergabunglah dengan komunitas global PI Network",
				text: "PI Network akan menjadi satu-satunya di bidang blockchain yang memecahkan hambatan teknis dan mengintegrasikan beberapa token protokol lintas-rantai dari jenis penyedia layanan terintegrasi. Masa depan adalah milik semua pemain aset digital blockchain. Mari kita bekerja sama untuk menyaksikan momen besar ini!",
			...
			partners_text: "Semua yang PI Network lakukan sekarang adalah untuk membuktikan bahwa kegigihan Fans Pi itu sepadan! Selamat datang lebih banyak platform dan institusi untuk bekerja sama dengan PI Network, email kontak resmi: pi@space-pi.com",
		...
		var i = {
			...
			station: {
				...
				c: [{
					...
					title: "NFT 시장",
					text: "PI Network Marketplace를 통해 참가자는 PI Network에서 유통되는 통화로 가격이 책정된 PI Network NFT를 관리하고 거래할 수 있습니다."
				}]
			},
			car1: [{
				text: "Pi Network",
			...
			answers: {
				...
				array: [{
					...
					title: "2. 메타버스가 중요합니까?",
					text: "Web3.0, 홀로그램 인터넷 기술, 블록체인, NFT의 통합을 기반으로 메타버스의 개념이 제시하는 가치는 인터넷의 핵심 가치와 일맥상통합니다. PI Network는 메타버스가 인터넷의 궁극적인 형태가 될 수 있다고 믿습니다. 따라서 우리는 게임을 출발점으로 NFT+ 메타버스를 기반으로 한 가상 생활 블록체인 게임 PI Network를 만들었습니다. 이러한 디지털 플랫폼의 중요성은 최근의 세계적 대유행 동안 명백해졌습니다."
				}, {
